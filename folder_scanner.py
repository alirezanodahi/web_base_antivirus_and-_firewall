...
API_KEY = 'ce3148b6a25a8e2cf8bfff350d995c4a0b8d653c35966552e8209f9cc756b86d'

# Initialize the VirusTotal client
client = vt.Client(API_KEY)

# Replace 'path/to/folder' with the actual path of the folder you want to scan
FOLDER_PATH = input("enter yout path to folder : ")
...
DAILY_QUOTA = 5000  # Maximum number of lookups per day
